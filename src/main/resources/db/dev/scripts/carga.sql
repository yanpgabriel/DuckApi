INSERT INTO PUBLIC.TB_ROLE (ID, NAME) VALUES (1, 'DUCK_ADM');
...
INSERT INTO PUBLIC.TB_APP (ID, DTCREATION, NAME, LINK, ICON) values (nextval('app_seq'), '2023-02-06 22:46:00.000000', 'Discord Bot', 'http://local.yanpgabriel.com:8069/', '');
